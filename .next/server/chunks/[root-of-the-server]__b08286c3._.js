module.exports = [
"[project]/.next-internal/server/app/api/user/profile/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
function getFirebaseAdmin() {
    ...
    return {
        app: app,
        auth: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$firebase$2d$admin$2f$auth__$5b$external$5d$__$28$firebase$2d$admin$2f$auth$2c$__esm_import$29$__["getAuth"])(app)
    };
}
;
__turbopack_async_result__();
...
async function GET(request) {
    try {
        ...
        const { auth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFirebaseAdmin"])();
        const decodedClaims = await auth.verifySessionCookie(sessionCookie);
        const uid = decodedClaims.uid;
        // Get user profile from Firestore using Admin SDK
        const admin = await __turbopack_context__.A("[externals]/firebase-admin/firestore [external] (firebase-admin/firestore, esm_import, async loader)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b08286c3._.js.map